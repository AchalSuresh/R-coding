...
# to see what the branches are, you can do the following. text(...,pretty=0) will make that the names appear as unchanged
...
# dev, in this case, is the fraction of stores that were misclassified (high-sales stores classified as low or vice versa)
names(cv.carseats)
